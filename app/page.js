          ...
          {[1, 2, 3].map(index => (
            <div className="col-md-4" key={index}>
              <div className="card mb-3">
                <img src="/img/45.jpg" className="card-img-top custom-img" alt="Card Image" />
                <div className="card-body text-center">
                  <h5 className="card-title">Durian tree</h5>
                  <p className="card-text">ต้น ทุเรียน</p>
                  <a href="#" className="btn btn-danger">ทุเรียนนนนนน!!</a>
                </div>
              </div>
            </div>
          ))}
              ...
              <div className="col-md-4" key={index}>
                <div className="card mb-3">
                  ...
                  <div className="card-body text-center">
                    ...
                    <p className="card-text">ต้น ทุเรียน</p>
                    <a href="#" className="btn btn-primary">ทุเรียนนนนนน?</a>
                  </div>
                </div>
              </div>
            ))}
